...
int main()
{
  ...
  {
    int n; // Declare a variable to store the size of the permutation
    cin >> n; // Read the size of the permutation
    vector<int> a(n); // Declare a vector to store the permutation elements
    for (int i = 0; i < a.size(); i++) // Loop to read the permutation elements
    {
